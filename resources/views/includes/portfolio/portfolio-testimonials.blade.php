        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <ul class="list-unstyled owl-ts-v1">
                    <li class="item">
                        <img class="rounded-x img-bordered" src="{{URL::to('resources/assets/img/team/img3-sm.jpg')}}" alt="">
                    ...
                    <li class="item">
                        <img class="rounded-x img-bordered" src="{{URL::to('resources/assets/img/team/img2-sm.jpg')}}" alt="">
                        <div class="testimonials-v3-title">
                            <p>Tina Krueger</p>
                    ...
                    <li class="item">
                        <img class="rounded-x img-bordered" src="{{URL::to('resources/assets/img/team/img1-sm.jpg')}}" alt="">
                        <div class="testimonials-v3-title">
                            <p>John Clarck</p>
