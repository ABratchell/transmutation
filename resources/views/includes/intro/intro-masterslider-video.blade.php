    ...
    <div class="master-slider ms-skin-default" id="masterslider">
        <div class="ms-slide">
            ...
            <h3 class="ms-layer video-title" style="right:41px; bottom:40px; background-color:#313D50;"
                data-effect="rotateback(20,620,br)" data-ease="easeOutQuad" data-delay="100">Red Bull Signature Series
                2013</h3>
            <h4 class="ms-layer video-author" style="right:285px; bottom:14px; background-color:#86838B; color:#FFF;"
                data-effect="rotate3dbottom(95,0,0,100)" data-ease="easeOutExpo" data-duration="1400" data-delay="500">
                by Vogner</h4>
        ...
        <div class="ms-slide">
            ...
            <h3 class="ms-layer video-title" style="right:53px; bottom:99px; background-color:#899798;"
                data-effect="rotatefront(20,620,br)" data-ease="easeOutQuad" data-delay="100">A Good Year for Extreme
                Sports</h3>
            <h4 class="ms-layer video-author" style="right:267px; bottom:75px; background-color:#595247; color:#fff;"
                data-effect="rotate3dbottom(95,0,0,100)" data-ease="easeOutExpo" data-duration="1400" data-delay="500">
                by Family Creative</h4>
        ...
        <div class="ms-slide">
            ...
            <h3 class="ms-layer video-title" style="left:51px; bottom:101px; background-color:#333;"
                data-effect="rotateback(20,620,br)" data-ease="easeOutQuad" data-delay="100">Where things come from</h3>
            <h4 class="ms-layer video-author" style="left:51px; bottom:76px" data-effect="rotate3dbottom(95,0,0,100)"
                data-ease="easeOutExpo" data-duration="1400" data-delay="500">by Hardy Seiler</h4>
        ...
        <div class="ms-slide">
            ...
            <h3 class="ms-layer video-title" style="left:70px; bottom:140px; background: #6D6F6E; "
                data-effect="rotatebottom(20,20,br)" data-ease="easeOutQuad" data-delay="100">RENAN OZTURK // REEL
                2013</h3>
            <h4 class="ms-layer video-author" style="left:70px; bottom:115px; background-color:#A09996; color:#FFF;"
                data-effect="rotate3dbottom(95,0,0,100)" data-ease="easeOutExpo" data-duration="1400" data-delay="500">
                by Camp 4 Collective</h4>
        ...
        <div class="ms-slide">
            ...
            <h3 class="ms-layer video-title" style="right: 48px; bottom:49px; background-color: #23354E;"
                data-effect="rotateleft(20,120,br)" data-ease="easeOutQuad" data-delay="100">Buenos Aires Ciudad </h3>
            <h4 class="ms-layer video-author" style="right: 136px; bottom:24px" data-effect="rotate3dbottom(95,0,0,100)"
                data-ease="easeOutExpo" data-duration="1400" data-delay="500">by Esteban Diácono</h4>
        ...
        <div class="ms-slide">
            ...
            <h3 class="ms-layer video-title" style="left: 81px; bottom:86px; color:#000; background-color:#FFF;"
                data-effect="rotatefront(20,620,br)" data-ease="easeOutQuad" data-delay="100">DRAWNIMAL</h3>
            <h4 class="ms-layer video-author"
                style="left:81px; bottom:61px; color:#fff; background-color: #D08E82; padding:4px 16px;"
                data-effect="rotate3dbottom(95,0,0,100)" data-ease="easeOutExpo" data-duration="1400" data-delay="500">
                by Lucas Zanotto</h4>
        ...
        <div class="ms-slide">
            ...
            <h3 class="ms-layer video-title" style="left: 41px; top:10px; background-color: #813123;"
                data-effect="rotateback(20,620,br)" data-ease="easeOutQuad" data-delay="100">Lamborghini
                "Aventador"</h3>
            <h4 class="ms-layer video-author" class="ms-layer video-author"
                style="left:41px; top:55px; background-color: #696353; color:#fff; "
                data-effect="rotate3dbottom(95,0,0,100)" data-ease="easeOutExpo" data-duration="1400" data-delay="500">
                by Sehsucht</h4>
